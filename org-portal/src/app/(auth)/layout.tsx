...
import { Users2, BarChart3, UserPlus, Building2 } from "lucide-react";

const BENEFITS = [
  { icon: UserPlus,   title: "Bulk Enroll Employees",     desc: "Invite your whole team into certifications in one batch."    },
  { icon: BarChart3,  title: "Track Progress",             desc: "See completion, exam scores, and status for every seat."     },
  { icon: Users2,     title: "Manage Your Roster",          desc: "Add, remove, and reassign certifications as your team changes." },
  { icon: Building2,  title: "Dedicated Account Manager",   desc: "Your PAII account manager handles seats and billing."          },
];
          ...
          <div className="relative z-10 space-y-8">
            <div>
              ...
              >
                Manage Your Team&apos;s
                <br />
                <span style={{ color: "#2dd4bf" }}>AI Certifications</span>
              </h1>

              <p style={{ fontSize: "15px", lineHeight: "1.7", color: "rgba(255,255,255,0.55)" }}>
                Everything you need to enroll, track, and grow your organization&rsquo;s
                AI-certified workforce, in one place.
              </p>
            </div>
        ...
        <div className="w-full max-w-[420px]">
          <div
            ...
            style={{
              ...
              boxShadow: "0 1px 3px 0 rgb(0 0 0 / 0.06), 0 1px 2px -1px rgb(0 0 0 / 0.05)",
            }}
          >
            {children}
          </div>
