    ...
    <div className="min-h-screen bg-navy-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <h1 className="text-xl font-display font-black text-navy-900 mb-1">Administrator Sign In</h1>
          <p className="text-slate-500 text-sm mb-6">Restricted to admin accounts only.</p>
