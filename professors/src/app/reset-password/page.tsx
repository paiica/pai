...
import { Eye, EyeOff, Loader2, CheckCircle2, AlertCircle, GraduationCap } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        ...
        {!token ? (
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <p className="text-slate-500 text-sm mb-6">Choose a strong password for your professor account.</p>
...
export default function ProfResetPasswordPage() {
  return (
    <Suspense>
