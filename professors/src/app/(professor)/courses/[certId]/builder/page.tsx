                ...
                >
                  ...
                  {!studentView && (
                    <button
                      ...
                      className={cn("opacity-0 group-hover:opacity-100 p-0.5 rounded", isSelected ? "hover:bg-navy-800 text-navy-200" : "hover:bg-red-50 text-slate-400 hover:text-red-600")}
