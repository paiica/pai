...
import { Building2, Users2, BarChart3, Award, CheckCircle2, ArrowRight, Mail, Phone } from "lucide-react";

export const metadata: Metadata = {
  title: "Corporate Training & Group Enrollment",
  description: "Upskill your entire organization with PAI's group certification programs. Volume pricing, dedicated support, and custom learning paths.",
};
