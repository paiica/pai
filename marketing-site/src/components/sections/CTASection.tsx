...
export default function CTASection({ cmsContent = {} }: { cmsContent?: Record<string, any> }) {
  ...
  const subtitle   = cmsContent.subtitle   || "Join professionals from 48 countries who've earned their PAII credential. Each cohort is limited to ensure quality. Apply today to secure your spot.";
