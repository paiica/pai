...
const BENEFITS = [
  { icon: DollarSign, title: "Earn Up to 20% Commission",  desc: "On every certification and course sale you refer."    },
  { icon: BarChart3,  title: "Real-Time Dashboard",         desc: "Track clicks, leads, and commissions live."           },
  { icon: Link2,      title: "Unique Referral Links",        desc: "Personal links and QR codes ready to share."         },
  { icon: Award,      title: "Certified AI Products",        desc: "Promote industry-recognized AI certifications."       },
];
          ...
          <div className="relative z-10 space-y-8">
            <div>
              ...
              >
                Turn Your Network
                <br />
                <span style={{ color: "#2dd4bf" }}>Into Revenue</span>
              </h1>
