...
const DEFAULT_BLOCKS = [
  ...
  },
  {
    ...
    content: {
      ...
      cta_card_desc: "87% of PAII professionals begin with CAIP — the foundation of all credentials.",
  ...
  },
  {
    ...
    sort_order: 3,
    content: {
      title: "See PAII in Action",
      subtitle: "Discover how PAII certifications are transforming careers and organizations across industries.",
      videos: [{ url: "", label: "" }],
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      subtitle: "Join 3,200+ professionals who've advanced their careers with PAII credentials.",
      items: [
  ...
  },
  {
    ...
    content: {
      ...
      subtitle: "Join professionals from 48 countries who've earned their PAII credential. Each cohort is limited to ensure quality. Apply today to secure your spot.",
  ...
  },
  {
    ...
    content: {
      ...
      copyright: "Professional Artificial Intelligence Institute. All rights reserved.",
      bottom_links: [
