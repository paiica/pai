...
const NAV = [
  { href: "/professors/dashboard", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/professors/courses", icon: BookOpen, label: "My Courses" },
  { href: "/professors/grades", icon: FileText, label: "Submissions" },
];
