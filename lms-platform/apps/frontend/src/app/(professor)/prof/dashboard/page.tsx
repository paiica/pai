...
import { BookOpen, Users, FileText, CheckCircle, ChevronRight } from "lucide-react";
    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href="/prof/courses" className="text-sm text-navy-600 hover:text-navy-800 font-medium">
            View all →
          </Link>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/prof/submissions" className="card p-5 hover:shadow-md transition-shadow flex items-center gap-3">
        ...
        <Link href="/prof/courses" className="card p-5 hover:shadow-md transition-shadow flex items-center gap-3">
